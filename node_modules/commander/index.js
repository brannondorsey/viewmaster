...
Command.prototype.optionHelp = function(){
  ...
  return [pad('help', width) + '  ' + 'output usage information'] //uncomment above
...
Command.prototype.prompt = function(str, fn){
  // console.log("I should have prompted");
  var self = this;
  if ('string' == typeof str) {
    if (/ $/.test(str)){
      //console.log("I am prompting single line");
      return this.promptSingleLine.apply(this, arguments);
    } 
    //console.log("I am prompting multi line");
